    ...
    return (
      ...
      <div className="game-header">
          ...
          <div className="game-score">
            <p className="text-lg mb-4">Your score: {score}/{roundLength}</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <>
            <div className="article-card">
              ...
              <p className="article-content">{article.snippet}</p>
            </div>

            <div className="button-container">
              {article.source_options.map((choice, i) => (
                <button
                  key={i}
            ...
            {hasAnswered && (
              <div style={{ textAlign: 'center' }}>
                <button className="button-next" onClick={handleNext}>{round < roundLength ? 'Next Question →' : 'See Results'}</button>
              </div>
            )}
          </>
        )}
